      ...
      <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div className="mt-3 text-center">
          ...
          <div className="items-center px-4 py-3">
            <Link to="/sign-in" className="block px-4 py-2 bg-red-500 text-white text-base font-medium rounded-md w-full text-center shadow-sm hover:bg-red-700">
              Sign In
            </Link>
          ...
          <div className="items-center px-4 py-3">
            <button onClick={onClose} className="px-4 py-2 bg-white text-gray-700 text-base font-medium rounded-md w-full shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-300">
              Close
            </button>
          </div>
        </div>
